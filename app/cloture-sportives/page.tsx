...
import { CheckCircle, Trophy, Shield, Target, ArrowLeft } from "lucide-react";
import Image from "next/image";
import Link from "next/link";
import { useState, useEffect } from "react";

export default function ClôtureSportivesPage() {
      ...
      <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 text-center text-white max-w-4xl mx-auto px-4">
          ...
          <p className="text-xl md:text-2xl mb-8 leading-relaxed">
            Solutions de clôturage professionnelles pour terrains de sport et
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <h3 className="font-sans text-2xl font-bold text-[#444d55] mb-4">
                Solution Standard pour Terrains de Sport
              </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="text-center hover:shadow-lg transition-shadow">
              <CardContent className="p-6">
                <Trophy className="w-12 h-12 text-[#02742c] mx-auto mb-4" />
                <h3 className="font-sans font-semibold text-[#444d55] mb-2">
                  Terrains de Football
                </h3>
                <p className="text-gray-600 text-sm">
                  Clôturage sécurisé pour terrains de football et stades
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center hover:shadow-lg transition-shadow">
              <CardContent className="p-6">
                <Target className="w-12 h-12 text-[#02742c] mx-auto mb-4" />
                <h3 className="font-sans font-semibold text-[#444d55] mb-2">
                  Courts de Tennis
                </h3>
                <p className="text-gray-600 text-sm">
                  Solutions adaptées aux courts de tennis et sports de raquette
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center hover:shadow-lg transition-shadow">
              <CardContent className="p-6">
                ...
                <p className="text-gray-600 text-sm">
                  Sécurisation complète de complexes sportifs multi-activités
                </p>
              </CardContent>
            </Card>
          </div>
      ...
      <section className="py-16 px-4 bg-[#444d55] text-white">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="font-sans text-3xl md:text-4xl font-bold mb-6">
            Projet de Clôturage Sportif ?
          </h2>
          <p className="text-xl mb-8 opacity-90">
            Contactez nos experts pour une solution adaptée à vos installations
            sportives
          </p>
